...
| `firmware/rx` | Receptor (placa A): CSI del transmisor o del router → PC en tramas binarias con CRC, más el detector de movimiento en la placa |
...
Estado: fase 0 completa; fase 1 con el enlace TX→RX validado (faltan los experimentos a distancia); fase 2 con el detector listo, pendiente de ajustar con datos etiquetados; fase 3 con el detector corriendo en la ESP32, pendiente de probar en la placa (~33 % del total).
